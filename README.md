...
```clojure
[net.clojars.savya/stdnum-clj "0.22.0"]
```

deps.edn:

```clojure
net.clojars.savya/stdnum-clj {:mvn/version "0.22.0"}
```
...
<details>
<summary><b>All 121 types, by category</b></summary>
